<?php
    ...
    return [
        ...
        'services' => [
            ...
            'Washing machine'=> 'fa-solid fa-glass-water-droplet',
            'Dryer'=> 'fa-solid fa-tornado',
            'Air conditioning'=> 'fa-solid fa-fan',
            'Heating'=> 'fa-solid fa-temperature-high',
            'Dedicated workspace'=> 'fa-solid fa-layer-group',
            'TV'=> 'fa-solid fa-tv',
            'Hair dryer'=> 'fa-solid fa-wind',
            'Iron'=> 'fa-brands fa-yandex-international',
            'Features'=> 'fa-solid fa-file-contract',
            'Pool'=> 'fa-solid fa-person-swimming',
            'Hot tub'=> 'fa-solid fa-hot-tub-person',
            'Free parking'=> 'fa-solid fa-square-parking',
            'EV charger'=> 'fa-solid fa-bolt',
            'Cot'=> 'fa-solid fa-baby-carriage',
            'Gym'=> 'fa-solid fa-dumbbell',
            'BBQ grill'=> 'fa-solid fa-burger',
            'Breakfast'=> 'fa-solid fa-mug-saucer',
            'Smoking allowed'=> 'fa-solid fa-smoking',
            'Indoor fireplace'=> 'fa-solid fa-house-chimney-window',
            'Beachfront'=> 'fa-solid fa-water',
            'Waterfront'=> 'fa-solid fa-person-swimming',
            'Safety'=> 'fa-solid fa-shield',
            'Smoke alarm'=> 'fa-solid fa-bell',
            'Carbon monoxide alarm'=> 'fa-solid fa-bell'
        ],
        'sponsorships' => [
            [
                'name' => 'Basic',
